...
Name:           ros-humble-metro-benchmark-pub
Version:        0.1.1
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS metro_benchmark_pub package

License:        BSD 3-clause
Source0:        %{name}-%{version}.tar.gz

Requires:       ros-humble-metro-benchmark-msgs
Requires:       ros-humble-rclcpp
Requires:       ros-humble-ros-workspace
BuildRequires:  ros-humble-ament-cmake
BuildRequires:  ros-humble-ament-cmake-python
BuildRequires:  ros-humble-metro-benchmark-msgs
...
%changelog
* Mon Oct 02 2023 David V. Lu!! <davidvlu@gmail.com> - 0.1.1-1
